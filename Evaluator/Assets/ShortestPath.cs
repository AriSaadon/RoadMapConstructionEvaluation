...
{
    /// <summary>
    /// An a-star algorithm to return the shortest path from source to sink. 
    /// Note that the increase in code complexity is due to our map being hybrid and using roads instead of simple edges.
    /// </summary>
    ...
    public static Vector3[] AStarShortestPath(Map map, Coordinate source, Coordinate sink)
    {
        ...
        /// now that we have reached the sink, we have to reconstruct the exact path by traveling back the found intersections.
...
/// <summary>
/// Standard priority queue, a faster implementation can be used. However, this section of code is not a hotspot/bottleknecking.
/// </summary>
